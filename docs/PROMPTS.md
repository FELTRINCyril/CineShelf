...
| ~~**Rien ne lit `ActivityEntry`.**~~ **Réglé par `L18`** : `ActivityFeed` en est le premier lecteur, quinze prompts après le premier écrivain. **Il reste sans écran** — le fil est `V5b` — mais il est testé, y compris sur l'entrée dont la cible a disparu | ~~`L18`~~ · `V5b` pour l'écran |
